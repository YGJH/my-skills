---
name: cuda-parity-testing
description: Use when writing deterministic tests for CUDA kernels against a Python reference implementation, when verifying GPU-ported environment logic produces identical results to the original Python, or when asked about CUDA kernel parity testing, deterministic fixture-based testing, state snapshot comparison, or GPU-vs-CPU numerical verification
---
